...
export function runDoctor(options: DoctorOptions = {}): DoctorReport {
  ...
  if (!paths.homeMode && inv.extensions.length > 0 && !extensionCompatibility.mapExists) warnings.push("Missing .opencode/generated/agentx-extension-map.json. Run ogb sync.");
