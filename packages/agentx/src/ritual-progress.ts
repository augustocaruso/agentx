...
export const CHECK_PROGRESS_STEPS = {
  ...
  patchPreExtensionUpdate: {
    ...
    label: "Apply agentX patches before Gemini extension updates.",
  ...
  patchPostExtensionUpdate: {
    ...
    label: "Apply agentX patches after Gemini extension updates.",
  ...
  patchPostSync: {
    ...
    label: "Apply agentX patches after sync.",
